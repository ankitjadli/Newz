...
import com.squareup.picasso.Picasso;
    ...
    public class Openclicknews extends AppCompatActivity {
    private DatabaseReference mdatabse;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_openclicknews);
        mdatabse = FirebaseDatabase.getInstance().getReference().child("Delhi");

...
public class hindiclick extends AppCompatActivity {
    private DatabaseReference mdatabse;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_hindiclick);
        mdatabse = FirebaseDatabase.getInstance().getReference().child("Hindi");
